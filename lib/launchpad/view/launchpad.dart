...
import '../widgets/large_chart.dart';
...
class _MyBottomNavBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var device = const RealtimeDeviceModel(
      graph:
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          text: 'Is this indicative of Myocarditis?',
                    ...
                    Container(height: 200, child: LargeChart(device: device))
                  ],
                ),
              ),
            ),
